...
namespace saturnin{
    ...
    public:
        ...
        /**
         * Retrieve a pointer to a clause to export to some other clause allocator
         * @param lits the array of literals
         * @param sz the size of the array @a lits
         * @param lbd the lbd value of the clause represented by @a lits
         * @return the clause containing the literals in @a lits and having the lbd set to @a lbd
         */
        Clause* retrieveClause(const Lit * const lits, unsigned int sz, unsigned int lbd);

        /**
         * Provide a clause that may or may not have been generated by this clause allocator
         */
        void provideClause(Clause*& c);
